...
const BellIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color = colors.warm.clay }) => (
...
const BellOffIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color = colors.warm.inkFaint }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
const PlusIcon: React.FC<{ size?: number; color?: string }> = ({ size = 16, color = colors.warm.cream }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    <WarmScreen edges={["top"]}>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          ...
          >
            {alertsEnabled ? <BellIcon size={18} color={colors.warm.clay} /> : <BellOffIcon size={18} />}
          </Pressable>
      ...
      <ScrollView
        ...
        refreshControl={
          <RefreshControl
            ...
            tintColor={colors.warm.clay}
            colors={[colors.warm.clay]}
          />
        }
      >
