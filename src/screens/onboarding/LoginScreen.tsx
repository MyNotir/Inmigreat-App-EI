...
const MailIcon: React.FC<{ size?: number; color?: string }> = ({ size = 18, color = colors.accent }) => (
              ...
              <WarmCard >
                ...
                <View style={styles.fieldGap}>
                  <WarmInput
                    ...
                    leadingIcon={<MailIcon color={emailError ? colors.error : colors.accent} />}
                  />
                </View>
                ...
                {mode === "register" ? (
                  <View style={styles.fieldGap}>
                    <WarmInput
                      ...
                      leadingIcon={
                        <LockIcon color={confirmPasswordError ? colors.error : colors.accent} />
                      }
                    />
                  </View>
                ) : null}
