...
const FaceIdIcon: React.FC<{ size?: number; color?: string }> = ({ size = 70, color = colors.accent }) => (
...
const FingerprintIcon: React.FC<{ size?: number; color?: string }> = ({ size = 70, color = colors.accent }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
const ShieldCheckIcon: React.FC<{ size?: number; color?: string }> = ({ size = 22, color = colors.success }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
        ...
        <View style={styles.top}>
          <Animated.View style={[styles.iconWrap, iconStyle]}>
            <View style={styles.iconBg}>
              <BiometricIcon size={64} color={colors.accent} />
            </View>
          </Animated.View>
          ...
          <Animated.View style={[styles.cardWrap, cardStyle]}>
            <WarmCard >
              <View style={styles.benefitRow}>
                <ShieldCheckIcon size={22} color={colors.success} />
