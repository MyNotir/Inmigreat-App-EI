  ...
  return (
    ...
    >
      <View style={styles.caseHeader}>
        <View
          style={[styles.caseDot, { backgroundColor: caseData.accentColor || colors.warm.clay }]}
        />
          ...
          <View
            style={[
              styles.caseProgressFill,
              {
                ...
                backgroundColor: caseData.accentColor || colors.warm.sage,
              },
            ]}
          />
        </View>
  ...
  const userBubbleColor =
    stress === "acute"
      ...
      : stress === "elevated"
        ? colors.warm.sand
        : colors.warm.clay
  const userTextColor = stress === "calm" ? colors.warm.cream : colors.warm.ink
  const userBorder = stress === "acute" ? colors.status.urgentWarm : "transparent"
