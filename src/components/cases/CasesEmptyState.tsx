...
const ArrowRightIcon: React.FC<{ color?: string }> = ({ color = colors.warm.clay }) => (
...
const PaperFolderIcon: React.FC<{ size?: number; color?: string }> = ({ size = 28, color = colors.warm.clay }) => (
    ...
    <View style={[styles.scene, { minHeight }]}>
      <View style={styles.iconWrap}>
        <View style={styles.iconBg}>
          <PaperFolderIcon size={44} color={colors.warm.clay} />
        </View>
      </View>
      ...
      <WarmCard intensity="elevated" style={styles.ctaCardWrap}>
        <Pressable style={styles.ctaInner} onPress={onAddCase}>
          <View style={styles.ctaIconBubble}>
            <PaperFolderIcon size={22} color={colors.warm.cream} />
          </View>
